...
export const Main = () => {
    ...
    const [toastTrigger, setToastTrigger] = useState(0);  // Changed this to a number
    ...
    const fetchItems = async (search) => {
        const API_URL = `http://localhost:5000/Item/GetItemsKeyword?key=${search}`;
    ...
    return (
        <>
            {/* Pass the toastTrigger as a prop to CustomToast */}
            <CustomToast message="Maaf data yang anda cari tidak ditemukan" trigger={toastTrigger} />
